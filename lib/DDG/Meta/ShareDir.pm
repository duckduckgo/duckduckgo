...
sub apply_keywords {
	...
	# presence of t/share to determine if it was a "dev environment" or not, and
	# not find that dir, and falsely conclude the library in t/lib/ was
	...
	#			 -> $b = "$root"
	#
	# Noting of course, we don't know what "$root" is, and this codes purpose is
	# to find the value of $root.
	#
